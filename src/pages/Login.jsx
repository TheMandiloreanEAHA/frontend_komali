...
import { saveDataLocalStorage, getDataLocalStorage, deleteDataLocalStorage } from '../utils/localStorageHelper.js'
    ...
    <TopBar/>
      <div className="relative flex items-center justify-center text-center mt-44">
        ...
        <div className="rounded-lg flex items-center justify-center text-center shadow-[#999] shadow-inner px-8 py-6">
          <div>
            <br />
            <h1 className="mb-4 mt-8 font-semibold text-lg text-uv-text-black">Iniciar sesión</h1>
            ...
            <div className="mb-2">
              <label>
                <input type="checkbox" onClick={() => {setSaveUser(!saveUser)}} /> Recuérdame
              </label>
            </div>
