    ...
    return (
        <>
            ...
            <div className="fixed inset-0 flex flex-col top-[25vh] items-center text-center z-50">
                ...
                <div className="mt-8">
                    <div className="mt-6 p-4 text-4xl text-white-100 bg-uv-blue rounded-full absolute bottom-1 left-1/2 transform -translate-x-1/2 -translate-y-1/2 cursor-pointer" onClick={goScanScreen}>
                        <div class='flex flex-row justify-center items-center px-1'>
                            <img src={click} alt="Icono click" className="h-9 fill-white-100 stroke-white-100" />
                            <span class="ml-5">Toca para comenzar</span>
                        </div>
                    </div>
                </div>
            </div>
